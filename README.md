...
Demostrar el dominio de los fundamentos de **HTML** y el flujo de trabajo profesional con **Git / GitHub**

### Capacidades técnicas demostradas:
 - Estructura semántica de documentos HTML 5
 - Gestión de rutas relativas y navegación interna.
 - Organización de activos (Imágenes y directorios) bajo principios **Lean**
 - Control de versiones mediante **Conventional Commits**.
 ...
 - **Lenguaje:** HTML5
 - **Gestión:** Trello (Kanban), Notion (DevLog)
